...
{
  "$end", "error", "$undefined", "NUMBER", "BIN", "HEX", "OCT", "DEC",
  "$accept", "input", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 24 "converter.y"
    { convertAndPrint("bin", (yyvsp[(2) - (2)].str)); free((yyvsp[(2) - (2)].str)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 25 "converter.y"
    { convertAndPrint("hex", (yyvsp[(2) - (2)].str)); free((yyvsp[(2) - (2)].str)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 26 "converter.y"
    { convertAndPrint("oct", (yyvsp[(2) - (2)].str)); free((yyvsp[(2) - (2)].str)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 27 "converter.y"
    { convertAndPrint("dec", (yyvsp[(2) - (2)].str)); free((yyvsp[(2) - (2)].str)); ;}
    break;
